...
/**
 * GetHotel401ResponseDataInnerAdditionalPoliciesCotsAndExtraBedsInner Class Doc Comment
 *
 * @category Class
 * @package  Nuitee
 * @implements \ArrayAccess<string, mixed>
 */
class GetHotel401ResponseDataInnerAdditionalPoliciesCotsAndExtraBedsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetHotel401Response_data_inner_additional_policies_cots_and_extra_beds_inner';
    ...
    {
        $this->setIfExists('price_mode', $data ?? [], null);
        $this->setIfExists('rate_type', $data ?? [], null);
        $this->setIfExists('to_age', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets price_mode
     *
     * @param string|null $price_mode price_mode
     *
     * @return self
     */
    public function setPriceMode($price_mode)
    {
        ...
        if (is_null($price_mode)) {
            throw new \InvalidArgumentException('non-nullable price_mode cannot be null');
        }
    ...
    {
        return $this->container['to_age'];
    }

    /**
     * Sets to_age
     *
     * @param float|null $to_age to_age
     *
     * @return self
     */
    public function setToAge($to_age)
    {

        if (is_null($to_age)) {
            throw new \InvalidArgumentException('non-nullable to_age cannot be null');
        }

        $this->container['to_age'] = $to_age;
